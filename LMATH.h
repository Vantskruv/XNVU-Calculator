...
namespace LMATH
{
    double IAS_to_MACH(double IAS, double FL, double ISA);
    double MACH_to_IAS(double MACH, double FL, double ISA);
    static double feetToMeter(double f){ return 0.3048*f;}
