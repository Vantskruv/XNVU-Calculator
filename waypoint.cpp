...
const int WAYPOINT::ORIGIN_FMS = 1;
const int WAYPOINT::ORIGIN_EARTHNAV = 2;
const int WAYPOINT::ORIGIN_RSBN = 3;
const int WAYPOINT::ORIGIN_XNVU_FLIGHTPLAN = 4;
const int WAYPOINT::ORIGIN_XNVU = 5;
